...
//     console.log('调用window里面的addEventListener接受的参数:', res)
// }
//
// // 网页的标签  <>    node  标签补对象
// document = {
...
//         console.log('调用document里面的createElement接受的参数:', res)
//         if (res == 'div'){
//             return {}
//         }
//     },
//     addEventListener:function (res) {
//         console.log('调用document里面的addEventListener接受的参数:', res)
//     },
//     documentElement:function (res) {
//         console.log('调用document里面的documentElement接受的参数:', res)
//     }
// }
//
// navigator = {
...
var TOKEN_SERVER_TIME = 1723858000.111;
!function(n, t) {
    !function() {
        var r, e, a;
        r = e = a = n;
